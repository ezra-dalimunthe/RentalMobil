                            ...
                            <div class="form-group">
                                ...
                                <select name="manufacture_id" class="form-control select2">
                                    @foreach (App\Manufacture::orderBy('name', 'asc')->get() as $row)
                                        <option value="{{ $row->id }}"
                                            {{ $data->manufacture_id == $row->id ? 'selected' : '' }}>
                                            {{ title_case($row->name) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" name="license_number" value="{{ $data->license_number }}"
                                    class="form-control border-dark-50" required="">
                            </div>
                        </div>
                        <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" name="penalty" value="{{ $data->penalty }}"
                                    class="form-control border-dark-50" required="">
                            </div>
                        </div>
                    </div>
            ...
            $.getJSON("{{ route('car.getImage', $data->id) }}", function(data) {
                $.each(data, function(index, value) {
                    ...
                    $('#loadImage').append('<div class="col-md-3">' +
                        ...
                        '<a class="card-text btn btn-danger shadow-sm delete-photo" data-href="' + url +
                        '" href="#">' +
